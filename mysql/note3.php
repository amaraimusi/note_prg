...
<html lang="ja">
	<head>
		...
		<title>ワクガンス　|　MySQLの覚書</title><link rel='shortcut icon' href='/home/images/favicon.ico' />
...
<div id="sec3-7-2" class="sec1">
	<h3>フィールドを連結して検索 | CONCAT</h3>

	<pre>
	SELECT * FROM nekos WHERE <strong>CONCAT( neko_val, neko_name ,neko_date)</strong> LIKE '%2014%'
	</pre>
