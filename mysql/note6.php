...
<!-- --------------------------------------------------------------- -->
<div id="sec6-2-1" class="sec1" >
	<h3>オートインクリメントのリセット</h3>
	
	<pre>ALTER TABLE テーブル名 auto_increment = 1;</pre>
	<br>
	
	以下のようにすると100から振りなおされる。
	<pre>ALTER TABLE テーブル名 auto_increment = 100;</pre>
...
<div id="sec6-10" class="sec1">
	...
	<pre>	ALTER TABLE yagis RENAME TO yagis_bk;</pre>
