 ...
 * 
 * @date 2016-9-21 | 2017-9-25
 * @version 1.9 少しリファクタリング、複製機能を強化
 * 
 * @param object param
...
var AjaxCRUD =function(param,fieldData){
	...
	function _addTr(ent,add_row_index){
		...
		add_row_index *= 1; // 文字列型になっているので、数値型に変換する。
	...
	function _showForm(form,triggerElm){
		...
		var form_position = self.param.form_position;// フォーム位置フラグ
