 ...
 * 
 * @note
 * 2017-5-22のバージョンではレベル15まで定義
 * レベル16以降の休眠期間	(16-15)×365日
 * 
 * @version 1.3.1
 * @date 2016-4-15 | 2017-5-22
 * 
...
var LearnCounterK =function(option){
	...
	function setOptionIfEmpty(){
		...
		setOptionProp('dormants',[0,0.01,0.5,2,7,14,30,45,60,90,120,150,180,210,270,360]); // カテゴリコード
